...
PAQUETES = ['obspy', 'matplotlib', 'Pillow', 'flask']
...
LTA_SEC    = 10.0  # duracion de la ventana larga en segundos (referencia de ruido de fondo)
...
COOLDOWN_EVENTO = 10   # segundos de espera entre detecciones
...
def hilo_procesamiento():
    """
    Hilo que procesa los datos sismicos cada 5 segundos.
    
    Realiza dos tareas:
    1. Genera una nueva imagen del sismograma y la publica en la web
    2. Aplica el algoritmo STA/LTA para detectar eventos sismicos
    ...
    while True:   # bucle infinito: procesa continuamente mientras el sistema este corriendo
        time.sleep(5)   # espera 5 segundos entre cada ciclo de procesamiento
        try:
